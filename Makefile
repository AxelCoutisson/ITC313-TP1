...
SRCS       = main.cpp Reservation.cpp Date.cpp Chambre.cpp Hotel.cpp Client.cpp	#source file
SRCSS      = main.o Reservation.o Date.o Chambre.o Hotel.o Client.o	#name.o
OBJS       = $(SRCS:.cpp=.o)
